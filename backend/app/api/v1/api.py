...
from app.api.v1.endpoints import auth, users, clients, routes, health, geographic, client_schedule, master_data, supplier
...
api_router.include_router(geographic.router, prefix="/geography", tags=["geography"])
